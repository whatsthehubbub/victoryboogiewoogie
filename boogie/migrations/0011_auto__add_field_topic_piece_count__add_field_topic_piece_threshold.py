...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.piece_count'
        db.add_column('boogie_topic', 'piece_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Topic.piece_threshold'
        db.add_column('boogie_topic', 'piece_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.piece_count'
        db.delete_column('boogie_topic', 'piece_count')

        # Deleting field 'Topic.piece_threshold'
        db.delete_column('boogie_topic', 'piece_threshold')
    ...
    models = {
        ...
        'boogie.topic': {
            ...
            'piece_threshold': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
