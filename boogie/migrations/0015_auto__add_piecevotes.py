...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PieceVote'
        db.create_table('boogie_piecevote', (
            ...
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boogie.Player'])),
            ('piece', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boogie.Piece'])),
        ))
        db.send_create_signal('boogie', ['PieceVote'])


    def backwards(self, orm):
        # Deleting model 'PieceVote'
        db.delete_table('boogie_piecevote')
