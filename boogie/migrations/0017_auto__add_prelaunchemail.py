...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreLaunchEmail'
        db.create_table('boogie_prelaunchemail', (
        ...
        db.send_create_signal('boogie', ['PreLaunchEmail'])


    def backwards(self, orm):
        # Deleting model 'PreLaunchEmail'
        db.delete_table('boogie_prelaunchemail')
