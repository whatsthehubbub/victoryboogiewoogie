...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('boogie_notification', (
            ...
            ('for_player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boogie.Player'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('boogie', ['Notification'])

        # Adding field 'Player.send_emails'
        db.add_column('boogie_player', 'send_emails',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('boogie_notification')

        # Deleting field 'Player.send_emails'
        db.delete_column('boogie_player', 'send_emails')
