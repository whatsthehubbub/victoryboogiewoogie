...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('boogie_game', (
            ...
            ('days_between_reassign', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('boogie', ['Game'])


    def backwards(self, orm):
        # Deleting model 'Game'
        db.delete_table('boogie_game')
