...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Piece.rating'
        db.delete_column('boogie_piece', 'rating')

        # Adding field 'Piece.character'
        db.add_column('boogie_piece', 'character',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boogie.Character'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Piece.image'
        db.add_column('boogie_piece', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Piece.rating'
        db.add_column('boogie_piece', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Piece.character'
        db.delete_column('boogie_piece', 'character_id')

        # Deleting field 'Piece.image'
        db.delete_column('boogie_piece', 'image')
