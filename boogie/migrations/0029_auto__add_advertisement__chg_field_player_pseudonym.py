...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('boogie_advertisement', (
        ...
        db.send_create_signal('boogie', ['Advertisement'])


        # Changing field 'Player.pseudonym'
        db.alter_column('boogie_player', 'pseudonym', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting model 'Advertisement'
        db.delete_table('boogie_advertisement')


        # Changing field 'Player.pseudonym'
        db.alter_column('boogie_player', 'pseudonym', self.gf('django.db.models.fields.CharField')(max_length=255))
