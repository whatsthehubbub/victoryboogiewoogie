...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.piece_about_character'
        db.add_column('boogie_player', 'piece_about_character',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boogie.Character'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.piece_about_character'
        db.delete_column('boogie_player', 'piece_about_character_id')
    ...
    models = {
        ...
        'boogie.player': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'onelinebio': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'piece_about_character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['boogie.Character']", 'null': 'True', 'blank': 'True'}),
            'pseudonym': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
